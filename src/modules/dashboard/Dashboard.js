...
const SplitEarthSection = ({ isLoggedIn, history }) => (
  <section className="split-section">
    ...
    {!isLoggedIn && (
      <div style={{ textAlign: 'center', marginTop: '30px', gridColumn: '1 / -1' }}>
        <button 
          className="hero-cta-secondary" 
          onClick={() => history.push('/demo')}
          style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px' }}
...
const RotatingFeatures = ({ isLoggedIn, history }) => {
  ...
  return (
    <section className="rot-pro-section flex justify-center">
      <SprintoReplica />
      {!isLoggedIn && (
        <div style={{ textAlign: 'center', marginTop: '30px', width: '100%', position: 'absolute', bottom: '20px' }}>
          <button 
            className="hero-cta-secondary" 
            onClick={() => history.push('/demo')}
            style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px' }}
...
// ============================================
// WHY SAFESPHERE COMPONENT
// ============================================
const WhySafeSphere = ({ isLoggedIn, history }) => {
  const pillars = [
    {
      title: 'Reduce Risk & Compliance Burden',
      icon: ShieldCheck,
    ...
    return (
      <div className="dashboard-signed-in">
          ...
          <div className="dashboard-header-content" style={{
              ...
              {!isMobile && (
                <div>
                  ...
                  <p style={{
                    ...
                    margin: 0
                  }}>Enterprise Risk & Compliance Platform</p>
                </div>
              )}
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <UserCircle2 className="text-indigo-600" size={isMobile ? 20 : 24} />
                ...
                {!isMobile && (
                  <div style={{
                    ...
                    <span style={{
                      ...
                      color: '#9ca3af',
                      fontWeight: '500'
                    }}>{user.department?.name} Consultant</span>
                  </div>
                )}
        ...
        <main className="dashboard-main">
          ...
          <WhySafeSphere isLoggedIn={true} history={history} />
          ...
          <section className="dashboard-integrations-section">
            ...
            <p className="dashboard-section-subtitle">SafeSphere works seamlessly with 100+ enterprise tools</p>
            <div className="dashboard-integrations-grid">
              {['AWS', 'Azure', 'Google Cloud', 'ServiceNow', 'Okta', 'Slack'].map((name, idx) => (
                <div key={idx} className="dashboard-integration-card">
      ...
      <footer className="dashboard-footer">
        <div className="dashboard-footer-content">
          ...
          <div className="dashboard-footer-section">
            <h4>Product</h4>
            <ul>
              <li><a href="/risk-assessment">Risk Management</a></li>
              <li><a href="/compliance">Compliance</a></li>
              <li><a href="/gap-assessment">Gap Assessment</a></li>
            </ul>
          </div>
