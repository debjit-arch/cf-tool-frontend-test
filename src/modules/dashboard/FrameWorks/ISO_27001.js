...
//               SafeSphere helps you implement and maintain an ISO 27001‑aligned
...
//           <p>
//             SafeSphere guides you from scoping and risk assessments through
...
//       <section className="iso-section">
//         <div className="iso-section-header">
//           <h2>Automate ISO 27001 with SafeSphere</h2>
//           <p>
...
//             <p>
//               SafeSphere integrates with your cloud, CI/CD, HR and ticketing
...
//               <span>SafeSphere ISMS cockpit</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
//           <p>
//             See how SafeSphere helps you build a modern ISMS, stay continuously
...
//           © {new Date().getFullYear()} SafeSphere · ISO 27001 · Made in India
//         </div>
//       </footer>
//     </div>
//   );
      ...
      <div className="iso-orbit-container">
        ...
        <div className="iso-orbit-card iso-orbit-card-main">
          ...
          <div className="iso-orbit-main-gauge">
            ...
            <p>All systems synced · 324 controls monitored</p>
          </div>
        </div>
  ...
  >
    Talk to an expert
      ...
      <footer className="iso-footer">
        ...
        <div className="iso-footer-bottom">
          © {new Date().getFullYear()} SafeSphere · ISO 27001 · Made in India[file:1]
        </div>
      </footer>
    </div>
  );
