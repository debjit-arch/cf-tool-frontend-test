...
//             </div>
//             <div>
//               <p className="procedures-logo-text">SafeSphere</p>
...
//           <p>
//             Each procedure follows SafeSphere's standardized format: Purpose → Scope → 
...
//           <p>
//             Import these procedures into SafeSphere and start collecting evidence 
...
//           © {new Date().getFullYear()} SafeSphere · Procedures Library · Made in India
//         </div>
//       </footer>
//     </div>
//   );
    ...
    <div className="gauge-center">
      ...
      >
        <div className="procedures-section-header">
          <h2>Sample Implementation Workflows</h2>
          <p>
            Each procedure follows SafeSphere&apos;s standardized format:
      ...
      <section className="procedures-section cta-section">
        <div className="procedures-cta-section cta-content">
          <h2>Ready to Operationalize Compliance?</h2>
          <p>
            Import these procedures into SafeSphere and start collecting
    ...
    Talk to Expert
      ...
      <footer className="procedures-footer dashboard-footer">
        ...
        <div className="procedures-footer-bottom dashboard-footer-bottom">
          © {new Date().getFullYear()} SafeSphere · Procedures Library · Made in
          India
        </div>
      </footer>
    </div>
